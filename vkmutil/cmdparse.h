#ifndef VKMUTIL_CMDPARSE_
#define VKMUTIL_CMDPARSE_
...
/* Parse a list of valkey module arguments using a command schema. If a parsing error occurs,
...
int CmdParser_ParseValkeyModuleCmd(CmdSchemaNode *schema, CmdArg **cmd, ValkeyModuleString **argv,
