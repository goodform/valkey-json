...
extern Vector *__newVectorSize(size_t elemSize, size_t cap);
...
* otherwise 1
*/
extern int Vector_Get(Vector *v, size_t pos, void *ptr);

/* Get the element at the end of the vector, decreasing the size by one */
extern int Vector_Pop(Vector *v, void *ptr);
...
extern int __vector_PushPtr(Vector *v, void *elem);

/* resize capacity of v */
extern int Vector_Resize(Vector *v, size_t newcap);

/* return the used size of the vector, regardless of capacity */
extern int Vector_Size(Vector *v);

/* return the actual capacity */
extern int Vector_Cap(Vector *v);
